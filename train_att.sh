...
do
   ...
   CUDA_VISIBLE_DEVICES=0 python onlyBasetwoLoss_84.py --network resnet18 --shots 5 --augnum 5 --fixCls 1 --tensorname resNet-layer$i-5shot --chooseNum 30 --mixupLayer $i
